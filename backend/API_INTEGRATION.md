...
*   **Response Events**:
    ...
    3.  `event: done` — Тест завершен. Приходит JSON с аналитикой.
        ...
        {
          "topic_uid": "TOP-...",
          "mastery": { "score": 0.85 }, // Оценка владения (0.0 - 1.0)
          "analytics": {
...
*   **Method**: `POST`
*   **Логика построения**:
    *   Возвращает ровно **5 узлов** (подтем), отсортированных логически.
    *   Контент каждого узла строго соответствует выбранной теме (фильтрация в Neo4j).
    *   **Структура узла**:
        *   Микро-уроки: `lesson_i_do` (1 балл), `lesson_we_do` (1 балл), `lesson_you_do` (1 балл).
...
*   **Request Body**:
    ...
    {
      "subject_uid": "MATH-FULL-V1",
      "topic_uid": "TOP-SELECTED-TOPIC", // Тема, которую учим
      ...
      "nodes": [
        {
          ...
          "units": [
            { "type": "lesson_i_do", "title": "Изучение...", "payload": {...} },
            { "type": "lesson_we_do", "title": "Практика...", "payload": {...} },
            { "type": "lesson_you_do", "title": "Задание...", "payload": {...} },
            { "type": "lesson_test", "title": "Финальный тест", "payload": {...} }
          ]
        }
        // ... еще 4 узла
      ]
