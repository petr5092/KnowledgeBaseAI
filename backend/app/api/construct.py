...
async def magic_fill(payload: MagicFillInput) -> Dict:
    try:
        from app.services.ai_engine.ai_engine import generate_concepts_and_skills
    except Exception:
    ...
    for c in bundle.concepts:
        try:
            from app.services.vector.qdrant_service import embed_text, query_similar, upsert_concept
        ...
        if sims and sims[0][1] >= 0.92:
            ...
            try:
                from app.services.vector.qdrant_service import upsert_concept
